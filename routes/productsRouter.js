...
router.post("/", async (req, res) => {
    // Create new product
    try {
        await service.createProduct(req.body.name, req.body.brand, req.body.description, req.body.picture_uri, req.body.volume, req.body.amount, req.body.rating, req.body.price)
...
router.put("/", async (req, res) => {
    // Update all products 
    try {
        await service.updateAllProducts(req.body.name, req.body.brand, req.body.description, req.body.picture_uri, req.body.volume, req.body.amount, req.body.rating, req.body.price)
...
router.put("/:id", async(req, res) => {
    ...
    try {
        const pid = parseInt(req.params.id);
        await service.updateAllProducts(pid, req.body.name, req.body.brand, req.body.description, req.body.picture_uri, req.body.volume, req.body.amount, req.body.rating, req.body.price, req.body.categories)
